...
export default function TermsOfUse() {
  ...
  const handleAccept = () => {
    // Navigate to Sign Up and securely pass a flag that they accepted the terms
    navigate('/auth/signup', { state: { termsAccepted: true } });
  };

  const handleDecline = () => {
    // Send them back to Login if they refuse
    navigate('/auth/login');
  };

  return (
    <AuthLayout>
      {/* This wrapper forces the content to take up the full screen height.
      */}
      <div className="flex flex-col h-full min-h-[calc(100vh-8rem)]">
        
        {/* shrink-0 ensures the title never gets squished */}
        <h1 className="text-3xl font-bold mb-6 text-gray-900 shrink-0">Terms of Use</h1>
        
        {/* Replaced h-96 with flex-1. 
          This tells the box to grow and consume all remaining vertical space! 
        */}
        <div className="flex-1 space-y-6 text-[15px] text-gray-800 leading-relaxed mb-8 overflow-y-auto pr-4 custom-scrollbar">
          ...
          <div>
            <h2 className="font-bold mb-1 text-black">Disclaimer and Limitation of Liability</h2>
          ...
          <div>
            <h2 className="font-bold mb-1 text-black">Changes and Termination</h2>
            <p>The Site owner may update these Terms at any time without notice. Continued use of the Site constitutes acceptance of any changes. Access to the Site may be suspended or terminated at any time for any reason.</p>
          </div>
        ...
        {/* shrink-0 ensures the buttons stay anchored safely at the bottom */}
