...
import { ArrowLeft } from 'lucide-react'; // 1. Import the arrow icon
...
export default function VerifyAccount() {
  ...
  return (
    // 2. Removed showBack={true} so we can place our own custom back button
    <AuthLayout>
      <div className="flex flex-col justify-center min-h-[calc(100vh-10rem)] w-full max-w-xl mx-auto">
        
        {/* 3. Custom Inline Back Button placed right above the heading */}
        <button 
          onClick={() => navigate(-1)}
        ...
        <h1 className="text-4xl font-bold mb-4 text-gray-900">Please verify your account</h1>
        <p className="text-base text-gray-600 mb-10 leading-relaxed font-medium">
          We sent a verification code to <span className="font-bold text-gray-900">{user?.email || 'your email'}</span>.<br/>
